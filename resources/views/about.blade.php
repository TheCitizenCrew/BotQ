...
@section('title', 'À propos de BotQ')

@section('content')
<h1>À propos de BotQ</h1>

<p>Cette application permet de gérer des commandes (Queue) qui seront exécutées par un automate (Bot).</p>
...
<p><a href="http://php.net">Php</a>, <a href="http://lumen.laravel.com">Lumen</a>, <a href="http://jquery.com/">JQuery</a>, <a href="http://getbootstrap.com/">Bootstrap</a> ...</p>
